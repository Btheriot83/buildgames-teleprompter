...
if (!name) {
  console.error('usage: node scripts/r6-shot.mjs <name> [library|stage|playing]')
  process.exit(1)
}
const out = resolve('gauntlet/shots-r6', `${name}.png`)
mkdirSync(dirname(out), { recursive: true })
const base = process.env.R6_URL || 'http://127.0.0.1:5188'
